...
const TopicTrendsChart = ({ data, summaryText, onClusterChange, currentClusters }) => {
      ...
      <div style={{ marginBottom: '20px', padding: '15px', backgroundColor: '#f8f9fa', borderRadius: '8px', border: '1px solid #edf2f7', textAlign: 'left' }}>
        ...
        <div style={{ display: 'flex', gap: '15px', alignItems: 'center' }}>
          <input 
            ...
            style={{ flex: 1, cursor: 'pointer', accentColor: '#805ad5' }}
          />
          <button 
            onClick={handleApply}
            style={{ padding: '6px 12px', backgroundColor: '#805ad5', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer', fontWeight: 'bold' }}
          >
            Re-Cluster
          </button>
        </div>
